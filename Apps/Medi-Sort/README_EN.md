...
### v15.0-F [Inbound / Global Ultimate]

![Version](https://img.shields.io/badge/Version-v15.0--Inbound_Ultimate-blue?style=flat-square)
...
It bridges the language gap between tourists and Japanese doctors while strictly adhering to Japanese safety protocols. Version 15.0 introduces **Photo Analysis** for medications and a **Compact Medical Note** format.
...
### 4. 🔄 Session Manager
*   **Next Action Menu:** After generating the note, provides a 4-choice menu:
    *   `1. Edit` / `2. New Symptom (Keep Medical History)` / `3. New Person` / `4. Finish`.
